...
export class AccountService {
  ...
  ACCOUNT_API_NEW   = 'http://localhost:8080/api/account/new/';
  ACCOUNT_API_LIST  = 'http://localhost:8080/api/account/';

  ACCOUNT_API_DEPOSIT   = 'http://localhost:8080/api/account/transaction/deposit';
  ACCOUNT_API_TRANSFER  = 'http://localhost:8080/api/account/transaction/transfer';
